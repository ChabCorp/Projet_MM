...
$best_model = "4r7l_mod.BL00040014"
cd best 
# mkdir results 
# # mv 4r7l_mod.BL00040014.pdb" results
# cd results

# /usr/local/bin/scwrl4/Scwrl4 –i 4r7l_mod.BL00040014.pdb –o scwrl4.pdb

# # gromax
source /usr/local/gromacs2020.5/bin/GMXRC
gmx pdb2gmx -f 4r7l_mod.BL00040014.pdb -o 4r7l_mod.BL00040014.gro -p 4r7l_mod.BL00040014.top -i 4r7l_mod.BL00040014.itp -ignh
wait

gmx grompp -f mini.mdp -c 4r7l_mod.BL00040014.gro -p 4r7l_mod.BL00040014.top -o minimodel.tpr
wait
